...
public class NTHFIBONACCI {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Enter the Fibonacci position (e.g., NTHFIBONACCI(7)): ");
        String input = scanner.nextLine();

        if (input.startsWith("NTHFIBONACCI")) {
            ...
            System.out.println("Invalid command. Please use the format NTHFIBONACCI(N).");
        }
    }
}
